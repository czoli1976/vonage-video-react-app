...
import { OpentokProviderConfig } from '@api-lib/schemas/OpentokProviderConfig.schema';
...
class OpenTokVideoService implements IVideoProvider {
  private readonly opentok: OpenTok;

  constructor(private readonly config: OpentokProviderConfig) {
